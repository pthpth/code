...
class HanabiRunner(Runner):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                if step == 0 and episode > 0:
                    ...
                    try:
                        self.finished_training() # Put here for I have changed the train function
            ...
            if episode % self.log_interval == 0 and episode > 0:
                ...
                if self.env_name == "Hanabi":
                    ...
                    if self.use_wandb:
                        ...
                        self.summary_writer.add_scalars('average_score', {'average_score': average_score}, self.true_total_num_steps)
    ...
    def eval(self, total_num_steps):
        ...
        if self.use_wandb:
            ...
            self.summary_writer.add_scalars('eval_average_score', {'eval_average_score': eval_average_score}, total_num_steps)
    ...
    def eval_100k(self, eval_games=100000):
        ...
        eval_average_score = np.mean(eval_scores)
        print("eval average score is {}.".format(eval_average_score))        print("eval average score is {}.".format(eval_average_score))