...
exp="SMAC-LOAD4m_vs_5m-TrainSI-MAPPO-Steps50M"
dir_path="../../official_saved_models/4m_vs_5m/SMAC-4m_vs_5m-MAPPO-SuperLong50M(Seed3_Run1_Ser1)" # CHANGE THIS FOR Each policy model
seed=3
