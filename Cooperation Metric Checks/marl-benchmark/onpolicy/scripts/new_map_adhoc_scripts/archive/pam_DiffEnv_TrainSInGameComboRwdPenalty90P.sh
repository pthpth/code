...
exp="AdhocTrain_SMAC-4M_4MV5VDiffEnv-MAPPO(ComboModRwd)-(90PenaltyWithMax)"
...
--num_env_steps 50000000 --ppo_epoch 15 --use_value_active_masks --use_eval --eval_episodes 32  --cuda --use_wandb --eval_interval 100 --run_mixed_population --policy_model_dir_teamA "../../official_saved_models/4m/SMAC-4M-MAPPO-Steps50M(Seed6_Run1_Ser1)/Policy_Episode10.0M" --policy_model_dir_teamB "../../official_saved_models/4m_vs_5m/SMAC-4m_vs_5m-MAPPO-SuperLong50M(Seed3_Run1_Ser1)/Policy_Episode10.0M" --si_model_dir_teamA "../../official_saved_models/4m/SMAC-4M-MAPPO-Steps50M(Seed6_Run1_Ser1)/Policy_Episode10.0M/SMAC-LOAD4M-TrainSI-MAPPO-Steps50M-10M-Crashed/social_influence_ts10.0M" --si_model_dir_teamB "../../official_saved_models/4m_vs_5m/SMAC-4m_vs_5m-MAPPO-SuperLong50M(Seed3_Run1_Ser1)/Policy_Episode10.0M/SMAC-LOAD4m_vs_5m-TrainSI-MAPPO-Steps50M-10M-Crashed/social_influence_ts10.0M" --percent_team_A_agents 50 --group_social_influence_factor 0.9 # --group_social_influence_factor 0.5
