...
exp="AdhocTrain_SMAC-4M_4MV5VDiffEnv-MAPPO-7Penalty-50MPolicyVsUntrainedB2"
...
--num_env_steps 50000000 --ppo_epoch 15 --use_value_active_masks --use_eval --eval_episodes 32  --cuda --use_wandb --eval_interval 100 --run_mixed_population \
...
--si_model_dir_teamA "../../official_saved_models/4m/SMAC-4M-MAPPO-Steps50M(Seed6_Run1_Ser1)/Policy_Episode50.0M/SMAC-LOAD4M-TrainSI-MAPPO-Steps50M-50M-Seed6-Policy50M/social_influence_ts50.0M" \
 --percent_team_A_agents 50 --group_social_influence_factor 0.7 # --group_social_influence_factor 0.5

# There is no 'only use argmax action' in the above command. Since we are doing training
exp="AdhocTrain_SMAC-4M_4MV5VDiffEnv-MAPPO-7Penalty-50MPolicyVsUntrainedB1"
echo "env is ${env}, map is ${map}, algo is ${algo}, exp is ${exp}, seed is ${seed}"
...
--policy_model_dir_teamA "../../official_saved_models/4m/SMAC-4M-MAPPO-Steps50M(Seed6_Run1_Ser1)/Policy_Episode50.0M" \
--si_model_dir_teamA "../../official_saved_models/4m/SMAC-4M-MAPPO-Steps50M(Seed6_Run1_Ser1)/Policy_Episode50.0M/SMAC-LOAD4M-TrainSI-MAPPO-Steps50M-50M-Seed6-Policy50M/social_influence_ts50.0M" \
 --percent_team_A_agents 75 --group_social_influence_factor 0.7 # --group_social_influence_factor 0.5
