...
reward_type="$1"
exppre="${1}_NoTrainSI_NukedCritic_AdhocTeam_SMACDiffEnv-MAPPO"

echo "Starting script for ${exppre} we train policy but not SI here"
...
do
    ...
    --num_env_steps 3000000 --ppo_epoch 15 --use_value_active_masks --use_eval --eval_episodes 32  --cuda --use_wandb --eval_interval 10 --run_mixed_population \
